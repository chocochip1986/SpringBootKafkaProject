    ...
    public ResponseEntity<String> sendMessage(@PathVariable("id") int id) throws JSONException, UnsupportedEncodingException {
        switch (id) {
            ...
            case 3:
                ...
                break;
            case 4:
                JSONObject jsonObject = new JSONObject("{\"PERSON_ID\": \"3195195\", \"NATURAL_ID\": \"T5438518D\", \"PERSON_ID_TYPE\": \"NRIC\", \"NAME\": \"BOYBOY 1\", \"CITIZENSHIP_ATTAINMENT_DATE\": \"1992-10-31T16:00:00.000Z\", \"TYPE\": \"SINGAPORE_CITIZEN\", \"NATIONALITY_VALID_FROM\": \"1992-10-31T16:00:00.000Z\" }");
